...
class GCBlock(tf.keras.layers.Layer):
    ...
    def call(self, tensors):
        ...
        #print("p1: ", tf.math.reduce_mean(p1))
        #print("p3: ", tf.math.reduce_mean(p3))
        
        p1 = self.pp1_layer(p1)
        #print("p1: ", tf.math.reduce_mean(p1))
        
        i1 = self.pi1_layer([ind_2, p1, basis])
        #print("i1: ", tf.math.reduce_mean(i1))
        ...
        #print("i3: ", tf.math.reduce_mean(i3))
        ...
        print("p3 from p3 and i3: ", tf.math.reduce_mean(p3))

        p1t1 = self.dot_layer(p3) + p1
        p3t1 = self.scale3_layer([p3, p1t1])
        print("p1t1: ", tf.math.reduce_mean(p1t1))
        print("p3t1: ", tf.math.reduce_mean(p3t1))
...
class PiNet2_energy_print(tf.keras.Model):
    ...
    def __init__(
        ...
        """
        super(PiNet2_energy_print, self).__init__()
    ...
    def call(self, tensors):
        ...
        for i in range(self.depth):
            ...
            #print("P1 tensor: ", tf.math.reduce_mean(tensors["p1"]))
            #print("P3 tensor: ", tf.math.reduce_mean(tensors["p3"]))
